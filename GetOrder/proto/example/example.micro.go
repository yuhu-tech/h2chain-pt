...
/*
Package go_micro_srv_GetOrder is a generated protocol buffer package.
...
func (c *exampleService) GetOrder(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Example.GetOrder", in)
	out := new(Response)
...
func (h *exampleHandler) GetOrder(ctx context.Context, in *Request, out *Response) error {
	return h.ExampleHandler.GetOrder(ctx, in, out)
}
